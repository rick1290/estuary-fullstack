...
interface WorkshopPractitionersProps {
  practitioners: any[]
}

export default function WorkshopPractitioners({ practitioners }: WorkshopPractitionersProps) {
  return (
    <Card>
      <CardHeader>
        <CardTitle>{practitioners.length > 1 ? "Workshop Facilitators" : "Workshop Facilitator"}</CardTitle>
      </CardHeader>
      <Separator />
