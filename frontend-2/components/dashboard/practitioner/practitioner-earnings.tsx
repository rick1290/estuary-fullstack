        ...
        <Card>
          <CardContent className="p-6">
            <div className="space-y-2">
              ...
              <p className="font-serif text-3xl font-normal text-olive-900">$1,240</p>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="space-y-2">
              ...
              <p className="font-serif text-3xl font-normal text-olive-900">24</p>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="space-y-2">
              ...
              <p className="font-serif text-3xl font-normal text-olive-900">$51.67</p>
