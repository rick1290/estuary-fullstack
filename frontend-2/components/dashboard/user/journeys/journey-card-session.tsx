...
export default function JourneyCardSession({ journey }: JourneyCardSessionProps) {
  ...
  const nextSessionTime = journey.next_session_time
    ...
    : null
  const isUpcoming = nextSessionTime && isFuture(nextSessionTime)
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-start justify-between gap-2">
              <div>
                <Badge
                  variant="outline"
                  className="mb-1.5 text-[10px] uppercase tracking-wider font-medium text-olive-500 border-sage-200"
                >
                  Session
                </Badge>
