...
export default function JourneyCardWorkshop({ journey }: JourneyCardWorkshopProps) {
  ...
  return (
    ...
    >
      <div className="flex gap-3 sm:gap-4 p-3 sm:p-4 bg-white border border-sage-200/60 rounded-xl hover:border-amber-300 hover:shadow-md transition-all">
        {/* Image */}
        <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-xl overflow-hidden shrink-0 bg-amber-50">
        ...
        <div className="flex flex-col items-end justify-between shrink-0">
          ...
          <span className={`text-[12px] font-medium flex items-center gap-1 ${
            isJoinable ? "text-amber-700" : "text-olive-400 group-hover:text-olive-600"
          } transition-colors`}>
