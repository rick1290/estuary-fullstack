...
const StepLabel = ({ children, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className="flex flex-col items-start" {...props}>
    {children}
  </div>
)
const StepContent = ({ children, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className="mt-4 ml-8 pl-4 border-l border-muted" {...props}>
    {children}
  </div>
)
