          ...
          <CardContent>
            {earningsLoading ? (
              ...
              <>
                ...
                <p className="text-xs text-olive-600">Lifetime earnings</p>
              </>
            )}
          </CardContent>
        </Card>
          ...
          <CardContent>
            {balanceLoading ? (
              ...
              <>
                ...
                <p className="text-xs text-olive-600">48-hour hold period</p>
              </>
            )}
          </CardContent>
        </Card>
          ...
          <CardContent>
            {balanceLoading ? (
              ...
              <>
                ...
                <p className="text-xs text-olive-600">Weekly automatic payout</p>
              </>
            )}
          </CardContent>
        </Card>
                ...
                recentTransactions.results.map((transaction) => (
                  <div key={transaction.id} className="flex items-center justify-between border-b pb-4 last:border-0">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xs text-olive-600">After {balanceData?.commission_rate || 5}% commission</p>
                    </div>
                  </div>
                ))
              ) : (
