...
export const metadata = createMetadata({
  ...
  path: "/marketplace/practitioners",
})
...
export default async function PractitionersPage({ searchParams }: PractitionersPageProps) {
  ...
  return (
    <MarketplaceLayout
      ...
      sidebar={<MarketplaceFilters showServiceTypeFilter={false} showPriceFilter={false} showRatingFilter={false} showCategoriesFilter={false} />}
      patternType="leaf"
    >
