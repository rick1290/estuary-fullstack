    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "current_step",
                    models.CharField(default="profile_completion", max_length=50),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(help_text="Name of this schedule", max_length=100),
                ),
                (
                    "is_default",
                    models.BooleanField(
                ...
                (
                    "description",
                    models.TextField(
                        blank=True, help_text="Description of this schedule", null=True
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "holidays",
                    models.TextField(
                        blank=True, help_text="JSON list of holiday dates", null=True
                    ),
                ),
                (
                    "holidays_on",
                    models.BooleanField(
                        default=False, help_text="Whether to allow bookings on holidays"
                    ),
                ),
                (
                    "hours_buffer",
                ...
                (
                    ...
                    models.SmallIntegerField(
                        default=0,
                        help_text="Minimum days in advance a booking can be made",
                    ),
                ),
                ("is_active", models.BooleanField(default=True)),
            ],
            options={
                "db_table": "schedule_preferences",
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("video_presentation_url", models.URLField(blank=True, null=True)),
                (
                    "youtube_video_id",
                ...
                (
                    ...
                    models.ManyToManyField(
                        ...
                        to="practitioners.certification",
                    ),
                ),
                (
                    "educations",
                    models.ManyToManyField(
                        blank=True,
                        related_name="practitioners",
                        to="practitioners.education",
                    ),
                ),
                (
                    "modalities",
                    models.ManyToManyField(
                        blank=True, related_name="practitioners", to="utils.modality"
                    ),
                ),
            ],
            options={
