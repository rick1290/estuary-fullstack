...
# Courier Template IDs
COURIER_CLIENT_WELCOME_TEMPLATE = os.environ.get('COURIER_CLIENT_WELCOME_TEMPLATE', 'CLIENT_WELCOME_V1')
COURIER_CLIENT_EMAIL_VERIFICATION_TEMPLATE = os.environ.get('COURIER_CLIENT_EMAIL_VERIFICATION_TEMPLATE', 'CLIENT_EMAIL_VERIFICATION_V1')
COURIER_CLIENT_BOOKING_CONFIRMATION_TEMPLATE = os.environ.get('COURIER_CLIENT_BOOKING_CONFIRMATION_TEMPLATE', 'CLIENT_BOOKING_CONFIRMATION_V1')
COURIER_CLIENT_PAYMENT_SUCCESS_TEMPLATE = os.environ.get('COURIER_CLIENT_PAYMENT_SUCCESS_TEMPLATE', 'CLIENT_PAYMENT_SUCCESS_V1')
...
COURIER_PRACTITIONER_NO_SERVICES_TEMPLATE = os.environ.get('COURIER_PRACTITIONER_NO_SERVICES_TEMPLATE', 'PRACTITIONER_NO_SERVICES_V1')
COURIER_PRACTITIONER_BOOKING_RECEIVED_TEMPLATE = os.environ.get('COURIER_PRACTITIONER_BOOKING_RECEIVED_TEMPLATE', 'PRACTITIONER_BOOKING_RECEIVED_V1')
COURIER_PRACTITIONER_BOOKING_CANCELLED_TEMPLATE = os.environ.get('COURIER_PRACTITIONER_BOOKING_CANCELLED_TEMPLATE', 'PRACTITIONER_BOOKING_CANCELLED_V1')
COURIER_PRACTITIONER_PAYOUT_COMPLETED_TEMPLATE = os.environ.get('COURIER_PRACTITIONER_PAYOUT_COMPLETED_TEMPLATE', 'PRACTITIONER_PAYOUT_COMPLETED_V1')
COURIER_PRACTITIONER_REMINDER_24H_TEMPLATE = os.environ.get('COURIER_PRACTITIONER_REMINDER_24H_TEMPLATE', 'PRACTITIONER_REMINDER_24H_V1')
COURIER_PRACTITIONER_REMINDER_30M_TEMPLATE = os.environ.get('COURIER_PRACTITIONER_REMINDER_30M_TEMPLATE', 'PRACTITIONER_REMINDER_30M_V1')
COURIER_PRACTITIONER_EARNINGS_SUMMARY_TEMPLATE = os.environ.get('COURIER_PRACTITIONER_EARNINGS_SUMMARY_TEMPLATE', 'PRACTITIONER_EARNINGS_SUMMARY_V1')
