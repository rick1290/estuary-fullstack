...
# HTTPS and HSTS (production only)
# Render (and most reverse proxies) terminate SSL and forward HTTP.
# This header tells Django the original request was HTTPS, preventing redirect loops.
